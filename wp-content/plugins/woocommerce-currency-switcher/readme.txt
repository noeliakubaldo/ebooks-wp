...
R: [demo.currency-switcher.com](https://demo.currency-switcher.com/)

Q: Documentation?
R: [CODEX](https://currency-switcher.com/codex/)

Q: Videos?
R: [Video Tutorials](https://currency-switcher.com/video/)
...
= 1.3.9 =
* [https://currency-switcher.com/update-v-2-3-9-v-1-3-9/](https://currency-switcher.com/update-v-2-3-9-v-1-3-9/)
...
= 1.3.6 =
* [https://currency-switcher.com/update-v-2-3-6-v-1-3-6/](https://currency-switcher.com/update-v-2-3-6-v-1-3-6/)

= 1.3.5 =
* Smart Designer added: [Description](https://currency-switcher.com/how-to-customize-currency-switcher-view/), [Demo page](https://demo.currency-switcher.com/woocs-smart-designer)

= 1.3.4.3 =
* heap of small fixes in code: css, js

= 1.3.4.2 =
* [fixed possibility for adding custom translations](https://currency-switcher.com/translations/)
...
= 1.3.3 =
* [https://currency-switcher.com/update-v-2-3-3-v-1-3-3/](https://currency-switcher.com/update-v-2-3-3-v-1-3-3/)

= 1.3.2 =
* [https://currency-switcher.com/update-v-2-3-2-v-1-3-2/](https://currency-switcher.com/update-v-2-3-2-v-1-3-2/)

= 1.3.1 =
* [https://currency-switcher.com/update-v-2-3-1-v-1-3-1/](https://currency-switcher.com/update-v-2-3-1-v-1-3-1/)
