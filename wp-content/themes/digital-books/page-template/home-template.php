...
<main id="skip-content">
      ...
      <?php  while ( $digital_books_query->have_posts() ) : $digital_books_query->the_post(); ?>
        <div class="slider-box">
          ...
          <div class="slider-inner-box">
            <?php if(get_theme_mod('digital_books_slider_title_setting',1) == 1){ ?>
              <h2><?php the_title(); ?></h2>
            <?php }?>
            <?php if(get_theme_mod('digital_books_slider_content_setting',1) == 1){ ?>
              <p ><?php echo esc_html( wp_trim_words( get_the_content(), 30 )); ?><p>
            <?php }?>
            <?php if(get_theme_mod('digital_books_slider_button_setting',1) == 1 && get_theme_mod('digital_books_slider_button_text','READ MORE') != ''){ ?>
              <div class="slide-btn"><a href="<?php the_permalink(); ?>"><?php esc_html_e(get_theme_mod('digital_books_slider_button_text','READ MORE')); ?></a></div>
            <?php }?>
          </div>
        </div>
      <?php $i++; endwhile;
  ...
  <?php if(get_theme_mod('digital_books_product_section_setting' ,true ) != ''){ ?>
